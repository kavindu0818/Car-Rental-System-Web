      ...
      <div className="bg-gradient-to-r from-indigo-900 to-blue-900 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-100 max-w-3xl mx-auto">
            Find a Kmw Car Rental location near you for convenient pick-up and drop-off
          </p>
        </div>
      </div>
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Visit us at one of our convenient locations. Our friendly team is here to make your car rental
                experience easy and enjoyable.
              </p>

              <div
                  className="bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-lg flex items-start border border-indigo-100 dark:border-indigo-800/50">
                <MapPin className="h-5 w-5 text-indigo-600 dark:text-indigo-400 mr-2 mt-0.5 flex-shrink-0"/>
                <p className="text-indigo-800 dark:text-indigo-300 text-sm">
                  All our locations offer convenient parking, accessible entrances, and extended hours to accommodate
                  your schedule.
                </p>
              </div>
            </div>
